...
import { Card, CardBody, ArrowForwardIcon, Link, Button, Text, Skeleton, Flex } from 'uikit'
...
const PredictionPromotionCard = () => {
  ...
  return (
    <StyledPredictionCard>
      <CardBody>
        <PredictionLive mb="24px">{t('Predictions')}</PredictionLive>
        <PredictionOver bold color="white">
          {over}
        </PredictionOver>
        {bnbWonInUsd ? (
         null // <PredictionWon mb="24px" color="white" bold prefix="$" decimals={0} value={bnbWonInUsd} />
        ) : (
          <>
        ...
        {/* <Link  id="homepage-prediction-cta"> */}
          <Button px={['14px', null, null, null, '20px']}>
            <PredictionTryNow>
              <Text color="white" bold fontSize="16px">
               Coming Soon :) {/* {t('Try Now')} */}
              </Text>
