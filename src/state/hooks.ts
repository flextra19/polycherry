...
export const usePollCoreFarmData = () => {
  ...
  useEffect(() => {
    dispatch(fetchFarmsPublicDataAsync([19, 17]))
...
export const usePriceCakeBusd = (): BigNumber => {
  ...
  // return prices ? new BigNumber(prices[tokens.cake.address[137].toLocaleLowerCase('en-US')].priceUSD) : new BigNumber(cakeBnbFarm.token.busdPrice);
