const tokens = {
  ...
  lokum: {
    ...
    address: {
      ...
      97: '0x4046065B847BD4057D7107f84e2511c6cd833eF8',
    },
    decimals: 18,
	 busdPrice: 0.03,
    projectLink: 'https://lokum.finance/',
  },
  busd: {
    symbol: 'BUSD',
    address: {
  ...
  simurgh:{
	  symbol:'SIMURGH',
	  address:{
		  137:'0xe7df368e774976d0e21c4e6537ae4b07904d731d',
		  97:'0x13A65D7A982a874efB9d637aF1415fc405C07736',
	  },
	  decimals:18,
	  projectLink:'https://simurgh.finance',
  },
  xrp: {
    symbol: 'XRP',
    address: {
